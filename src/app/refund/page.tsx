...
const refundPolicy = [
    {
        title: "No Refunds",
        content: [
            "At blinkcard, we strive to provide our customers with high-quality digital products and services. However, we understand that there may be occasions where a refund is necessary.",
            "Please read our refund policy carefully before making a purchase:",
            "We do not offer refunds for payments made for the blinkcard virtual business card and business profile solution. All payments are considered final and non-refundable."
        ]
    },
    {
        title: "Quality Assurance",
        content: [
            "We stand behind the quality and functionality of our blinkcard solution. If you encounter any issues or have any concerns about your purchase, please contact our customer support team for assistance."
        ]
    },
    {
        title: "Exceptional Circumstances",
        content: [
            "In rare cases where a refund may be considered due to extenuating circumstances, such as a technical issue preventing access to the blinkcard solution, we will review the situation on a case-by-case basis.",
            "Any refund granted in exceptional circumstances will be at the sole discretion of blinkcard."
        ]
    },
    {
        title: "Unauthorized Transactions",
        content: [
            "If you believe that an unauthorized transaction has been made using your payment information to purchase the blinkcard solution, please contact us at info@blinkcard.com immediately to report the issue.",
    ...
    },
    {
        ...
        content: [
            "blinkcard reserves the right to modify or update this refund policy at any time without prior notice.",
    ...
    },
    {
        title: "Contact Us",
        content: [
            "If you have any questions or concerns about our refund policy, please contact our customer support team at info@blinkcard.com or call +251988410000.",
            "By making a purchase of the blinkcard solution, you acknowledge and agree to abide by the terms of this refund policy.",
            "Thank you for choosing blinkcard for your virtual business card needs."
        ]
    },
    {
        title: "Cancellation",
        content: [
            ...
            "In order to exercise your right of cancellation, you must inform us of your decision via email at info@blinkcard.com by means of a clear statement.",
    ...
    return (
        <main className="min-h-screen bg-neutral-50 py-16 px-4">
            <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8">
                <h1 className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">blinkcard Refund Policy</h1>
