...
export default function Home() {
  return (
    <div className="font-poppins bg-white text-gray-900">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <nav className="flex items-center w-full">
            ...
            <ul className="hidden md:flex ml-10 gap-8 text-base font-medium items-center">
              ...
              <li><a href="#how-it-works" className="hover:text-orange-400 transition">Process</a></li>
              <li><a href="#demo" className="hover:text-orange-400 transition">Demo</a></li>
              <li><a href="#contact" className="hover:text-orange-400 transition">Contact</a></li>
              <li>
                <Link href="/menu" className="hover:text-orange-500 font-semibold transition">
                  View Menu
                </Link>
              </li>
              <li>
                <Link href="/auth/login" className="hover:text-orange-500 font-semibold transition px-4 py-2 rounded border border-orange-500 ml-2">
                  Login
                </Link>
              </li>
              <li>
                <Link href="/auth/register" className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-4 py-2 rounded ml-2 transition">
                  Get Started
                </Link>
              </li>
            </ul>
            <a href="#contact" className="call-order-btn ml-auto hidden md:inline-block bg-gradient-to-r from-orange-500 to-yellow-300 text-white font-bold text-base rounded-full px-7 py-2 shadow hover:from-yellow-300 hover:to-orange-500 transition">Call for Order</a>
      ...
      {/* Hero Section */}
      <section className="hero bg-gradient-to-br from-orange-50 to-yellow-50 py-16">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 px-4">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a href="#demo" className="btn btn-primary bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-full shadow">View Demo</a>
              <a href="#contact" className="btn btn-outline border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white font-semibold px-6 py-3 rounded-full transition">Get Started</a>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 justify-center">
            ...
            <div className="flex flex-col items-center gap-4">
              <a href="demo.html" className="btn btn-primary bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-full shadow">Interactive Demo</a>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mt-6 gap-2">
            <span className="dot w-3 h-3 rounded-full bg-orange-400 inline-block"></span>
      ...
      {/* CTA Section */}
      <section className="cta py-16 bg-gradient-to-r from-orange-500 to-yellow-300 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <a href="#contact" className="btn btn-primary bg-white text-orange-500 font-semibold px-8 py-3 rounded-full shadow hover:bg-orange-100 transition">Get Started Now</a>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-12">
          <div className="flex-1">
            ...
            <form className="contact-form grid grid-cols-1 gap-4">
              <input type="text" placeholder="Your Name" required className="form-input px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
              <input type="email" placeholder="Your Email" required className="form-input px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
              <input type="text" placeholder="Restaurant Name" required className="form-input px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
              <input type="tel" placeholder="Phone Number" required className="form-input px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
              <textarea placeholder="Tell us about your menu needs" rows={5} required className="form-textarea px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" />
              <button type="submit" className="btn btn-primary bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-full shadow">Request Demo</button>
            </form>
          </div>
          <div className="flex-1 flex flex-col gap-6 justify-center">
            ...
            <div className="flex gap-4 mt-2">
              <a href="#" className="text-gray-500 hover:text-orange-500 text-xl"><i className="fab fa-facebook-f"></i></a>
              <a href="#" title="Facebook" className="text-gray-500 hover:text-orange-500 text-xl"><i className="fab fa-facebook-f"></i></a>
              <a href="#" title="Twitter" className="text-gray-500 hover:text-orange-500 text-xl"><i className="fab fa-twitter"></i></a>
              <a href="#" title="Instagram" className="text-gray-500 hover:text-orange-500 text-xl"><i className="fab fa-instagram"></i></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li><a href="#" className="hover:text-orange-400 transition">Digital Menu Creation</a></li>
                <li><a href="#" className="hover:text-orange-400 transition">Menu Photography</a></li>
                <li><a href="#" className="hover:text-orange-400 transition">QR Code Setup</a></li>
                <li><a href="#" className="hover:text-orange-400 transition">Menu Updates</a></li>
              </ul>
            </div>
            <div>
...
function FeatureCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    <div className="feature-card bg-gray-50 rounded-xl shadow p-6 flex flex-col items-center text-center gap-4">
      <div className="feature-icon text-3xl text-orange-500 mb-2">
...
function StepCard({ number, title, desc }: { number: number; title: string; desc: string }) {
  return (
    <div className="step flex flex-col items-center text-center gap-3">
      <div className="step-number w-12 h-12 flex items-center justify-center rounded-full bg-orange-500 text-white text-2xl font-bold mb-2">{number}</div>
...
function TestimonialCard({ active, content, authorImg, authorName, authorTitle }: { active?: boolean; content: string; authorImg: string; authorName: string; authorTitle: string }) {
  return (
    <div className={`testimonial bg-white rounded-xl shadow p-6 max-w-md flex flex-col gap-4 ${active ? 'border-2 border-orange-400' : ''}`}>
