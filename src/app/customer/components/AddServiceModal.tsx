                                        ...
                                        {imageFiles.map((img, idx) => (
                                            <div key={idx} className="relative group">
                                                ...
                                                <button
                                                    ...
                                                    className={`absolute top-2 left-2 p-1.5 rounded-full shadow-md transition-opacity border-2 ${idx === 0 ? 'bg-gradient-to-r from-sky-600 via-cyan-500 to-teal-400 text-white border-sky-500' : 'bg-white text-black border-gray-300 opacity-80 hover:opacity-100'}`}
                                                    onClick={() => {
                                                        if (idx !== 0) {
                                                            setImageFiles(prev => {
                                                                const arr = [...prev];
                                    ...
                                    <div className="max-sm:space-y-3 space-y-6">
                                        <div>
                                            <div role="radiogroup" aria-required="false" dir="ltr" className="gap-2 flex flex-col space-y-2 outline-none" tabIndex={0}>
                                                <div
                                                    className={`flex items-start space-x-2 p-3 rounded-lg border transition-colors cursor-pointer ${selectedLocation === 'my-location' ? 'bg-gradient-to-r from-sky-600 via-cyan-500 to-teal-400  text-white' : 'bg-white border-gray-100 hover:border-gray-200 text-black'}`}
                                                ...
                                                >
                                                    <span className={`aspect-square h-4 w-4 rounded-full border flex items-center justify-center mt-1 ${selectedLocation === 'my-location' ? 'border-white bg-white' : 'border-black bg-white'}`}>
                                                        {selectedLocation === 'my-location' && <span className="block w-2 h-2 rounded-full bg-sky-600" />}
                                                    </span>
                                                ...
                                                {/* At client location */}
                                                <div
                                                    className={`flex items-start space-x-2 p-3 rounded-lg border transition-colors cursor-pointer ${selectedLocation === 'client-location' ? 'bg-gradient-to-r from-sky-600 via-cyan-500 to-teal-400  text-white' : 'bg-white border-gray-100 hover:border-gray-200 text-black'}`}
                                                ...
                                                >
                                                    <span className={`aspect-square h-4 w-4 rounded-full border flex items-center justify-center mt-1 ${selectedLocation === 'client-location' ? 'border-white bg-white' : 'border-black bg-white'}`}>
                                                        {selectedLocation === 'client-location' && <span className="block w-2 h-2 rounded-full bg-sky-600" />}
                                                    </span>
                                                    <div className="flex-1">
                                                ...
                                                <div
                                                    className={`flex items-start space-x-2 p-3 rounded-lg border transition-colors cursor-pointer ${selectedLocation === 'no-location' ? 'bg-gradient-to-r from-sky-600 via-cyan-500 to-teal-400  text-white' : 'bg-white border-gray-100 hover:border-gray-200 text-black'}`}
                                                ...
                                                >
                                                    <span className={`aspect-square h-4 w-4 rounded-full border flex items-center justify-center mt-1 ${selectedLocation === 'no-location' ? 'border-white bg-white' : 'border-black bg-white'}`}>
                                                        {selectedLocation === 'no-location' && <span className="block w-2 h-2 rounded-full bg-sky-600" />}
                                                    </span>
                                                    <div>
