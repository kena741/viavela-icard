    ...
    return [
        ...
        },
        {
            ...
            subItems: [
                ...
                {
                    label: 'Gallery',
                    href: '/customer/dashboard/settings/gallery',
                    icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-image h-4 w-4"><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" /></svg>
                    ),
                },
                {
                    label: 'Payment',
                    href: '/customer/dashboard/settings/payment',
                    icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-wallet h-4 w-4"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 11V9a4 4 0 0 0-8 0v2" /><path d="M8 15h8" /></svg>
                    ),
                },
            ],
        },
