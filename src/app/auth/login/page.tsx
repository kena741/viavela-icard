        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-2 text-gray-900">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow border border-gray-200">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <button
                        className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  bg-blue-600 hover:opacity-90 h-10 px-4 py-2 w-full text-white"
                        type="submit"
                        disabled={loading}
                    >
                        {loading ? (
                ...
                <div className="mt-6 text-center text-sm text-gray-800">
                    ...
                    <Link href="/auth/register" className="text-blue-600 hover:underline font-semibold">Register</Link>
                </div>
            </div>
        </div>
    );
